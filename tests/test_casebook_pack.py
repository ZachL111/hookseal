"""Regression checks for the hookseal casebook."""
...
from casebook.harness import assert_expected, hookseal_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(hookseal_summary(), assert_expected())
